...
;---------------------------------
*map
*A_02_50|空環市　弐日目の右往左往
@title name="&tf.title+  '---　空環市　弐日目の右往左往'"
@eval exp=" sf.title_list_2_2[8]=1 "
@fobgm
...
;★MAPを表示するかどうかの判断★
;MAPのカウントが一定以上の場合
@if exp="f.map_count_A_02_50 == 2"

;次のシナリオに飛ぶ
@eval exp="tf.jumpTo='A_02_60.ks'"
...
;■テレビ電波
@image layer=10 storage="denpa.png" visible=true top=160 left=110 page=back
...
;★川沿い(D)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_d2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50d.ks',f.灯吾p++,f.秋良p++" cond="f.scenario_flg_A_02_50d!=1" hint=""

;★商店街(E)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_e2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50e.ks',f.秋良p++" cond="f.scenario_flg_A_02_50e!=1" hint=""
...
;★朔薙(H)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_h1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50h.ks',f.灯吾f2=1,f.朔薙p++" cond="f.scenario_flg_A_02_50h!=1" hint=""
...
;★遠近家(L)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_l1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50l.ks',f.秋良p++" cond="f.scenario_flg_A_02_50l!=1" hint=""

;★幼稚園(M)

;★すすき野原(N)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_n3.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50n.ks',f.嵯峨野p++" cond="f.scenario_flg_A_02_50n!=1" hint=""

;★駅(O)

;★公園(P)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_p2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_50p.ks'" cond="f.scenario_flg_A_02_50p!=1" hint=""
...
@eval exp="tf.linkfrom='A_02_50.ks',tf.target='*map'"
@else
;呼び出し元
@eval exp="f.playmode='A_02_50.ks'"
