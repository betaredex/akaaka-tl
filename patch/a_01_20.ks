...
;---------------------------------
*map
*A_01_20|空環神社　壱日目の漫ろ歩き
@title name="&tf.title+  '---　空環神社　壱日目の漫ろ歩き'"
@eval exp=" sf.title_list_1_2[4]=1 "
@fobgm
@seopt volume=100
@bgmopt volume=100
...
;★MAPを表示するかどうかの判断★
;MAPのカウントが一定以上の場合
;@if exp="f.map_count_A_01_20 == 2"

;次のシナリオに飛ぶ（MAPから次のフェーズに直接移る場合だけ）
;@eval exp="tf.jumpTo='A_01_21.ks'"
...
;注）ここにはフラグなどで変動しない動的要素のみを入れてください（華南）
...
;最初は行けない
@locate x=433 y=0
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_nikai.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20h.ks'" cond="f.scenario_flg_A_01_20h!=1" hint=""
@button graphic="mapicon_jinja_nikai_sumi.png" 	 recthit=false  target="" exp=""  hint=""

;★居間
;このシナリオでは行かない
@locate x=405 y=35
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_ima.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20c.ks'" cond="f.scenario_flg_A_01_20c!=1" hint=""
@button graphic="mapicon_jinja_ima_sumi.png" recthit=false hint=""

;★廊下（E）
@locate x=479 y=37
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_rouka.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20e.ks',f.嵐昼p++" cond="f.scenario_flg_A_01_20e!=1" hint=""
@button graphic="mapicon_jinja_rouka_sumi.png" 	 recthit=false  target="" exp="" cond="f.scenario_flg_A_01_20e==1" hint=""

;★庭リンクボタン（F）
;このシナリオでは行かない
@locate x=397 y=100
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_niwa.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20f.ks'" cond="f.scenario_flg_A_01_20f!=1" hint=""
@button graphic="mapicon_jinja_niwa_sumi.png" recthit=false hint=""
...
;★本殿リンクボタン（G）
@locate x=261 y=52
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_honden.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20g.ks',f.ミコトp++" cond="f.scenario_flg_A_01_20g!=1" hint=""
@button graphic="mapicon_jinja_honden_sumi.png" 	 recthit=false  target="" exp="" cond="f.scenario_flg_A_01_20g==1" hint=""

;★拝殿リンクボタン
;このシナリオでは行かない
@locate x=219 y=74
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_haiden.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20c.ks'" cond="f.scenario_flg_A_01_20c!=1" hint=""
...
;★社務所リンクボタン（B）
@locate x=145 y=0
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_syamusyo.png"		 recthit=false   target="*jump_to_file" exp="tf.jumpTo='A_01_20b.ks',f.狭塔p++" cond=f.scenario_flg_A_01_20b!=1 hint=""
@button graphic="mapicon_jinja_syamusyo_sumi.png"	 recthit=false  target="" exp="" cond=f.scenario_flg_A_01_20b==1 hint=""
...
;★お札授与所リンクボタン（C）
@locate x=360 y=69
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_jinja_ohuda.png" 	 recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_01_20c.ks',f.足部p++" cond="f.scenario_flg_A_01_20c!=1" hint=""
@button graphic="mapicon_jinja_ohuda_sumi.png" 	 recthit=false  target="" exp="" cond="f.scenario_flg_A_01_20c==1" hint=""
...
;◆---------------------------------------
@elsif exp="f.map_count_A_01_20 == 2"
;3回目は強制選択
...
;★廊下（E）
@locate x=479 y=37
@button graphic="mapicon_jinja_rouka_sumi.png" recthit=false hint=""
...
;★本殿リンクボタン（G）
@locate x=261 y=52
@button graphic="mapicon_jinja_honden_sumi.png" recthit=false hint=""
...
;★社務所リンクボタン（B）
@locate x=145 y=0
@button graphic="mapicon_jinja_syamusyo_sumi.png" recthit=false hint=""
...
;★お札授与所リンクボタン（C）
@locate x=360 y=69
@button graphic="mapicon_jinja_ohuda_sumi.png" recthit=false hint=""
...
@eval exp="tf.linkfrom='A_01_20.ks',tf.target='*map'"
@else
;呼び出し元
@eval exp="f.playmode='A_01_20.ks'"
