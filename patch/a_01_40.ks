;---------------------------------------
;2010/6/23@Z³ASEABGM‘}“üi‚‹´j
;2010/6/27@––”öˆ—i‚‹´j
;2010/8/4@ƒ^ƒCƒgƒ‹’²®i‚‹´j
;2010/8/4@C³ASE‘}“üi‚‹´j
;2010/8/20@‰‰o’²®i‚‹´j
;2010/12/5@‘I‘ğˆ‚É•Ï”’Ç‰Ái‚©‚È‚ñj
;2011/2/28@C³iƒ†ƒEƒ~j
;2011/3/1@C³i‚‹´j
;2011/3/16 —§‚¿ŠG‘}“üiƒ†ƒEƒ~j
;2011/4/8@’²®i‚‹´j
;šššƒ|ƒCƒ“ƒgİ’èƒAƒŠ@‚ÅŒŸõ„‚¦‚è‚È
;2011/4/9 ƒpƒ‰ƒ[ƒ^”½‰fi‚©‚È‚ñj
;2011/4/20@ƒ^ƒCƒgƒ‹ƒŠƒXƒg‘Î‰i‚©j
;2011/4/22 ƒpƒ‰ƒ[ƒ^”½‰fi‚©j
;2011/4/27@C_aki2A_50@•šü‘Î‰
;---------------------------------------

*A_01_40_01|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@title name="&tf.title+  '---@•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg'"
...
;---‘I‘ğˆ‚Ì•\¦
@position2-1
[link target="*link2" exp="tf.toScenario='',tf.toLabel='*A_01_40_01a',f.flg_A_01_40_01a='1',f.H—Çp++"]Which should I pick?[endlink]
;’Öƒ|ƒCƒ“ƒg{‚P
@position2-2
[link target="*link2" exp="tf.toScenario='',tf.toLabel='*A_01_40_01b',f.“”Œáp++"]Try waiting a little longer[endlink]
;H—Ç{‚P
;---‘I‘ğˆ‚ÌI—¹
@endselect
...
;------------------------------------------------------------------------
;‚`‚Ìê‡G
*A_01_40_01a|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm
...
;---‘I‘ğˆ‚Ì•\¦
@position2-1
[link target="*link2" exp="tf.toScenario='',tf.toLabel='*A_01_40_01aa',f.flg_A_01_40_01aa='1',f.H—Çp++"]Okay[endlink]
;H—Çƒ|ƒCƒ“ƒg{‚P
@position2-2
...
*A_01_40_01aa|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm

;C_aki2A_50—p‚Ì•šü‰ñû—p
...
*A_01_40_01ab|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm
...
*A_01_40_01b|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm
@fobgm
...
*A_01_40_01ba|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm
...
*A_01_40_01bb|•ú‰ÛŒãƒ`ƒƒƒCƒ€‚Æ‹A‚éƒqƒg
@resetmsg
@cm
...
;@y’ßz
;™‚r‚d@‚±‚±‚ÅH—Ç‚ª”ò‚Ño‚Ä‚­‚éƒYƒVƒƒƒA‚Á‚ÄŠ´‚¶‚Ì‰¹“ü‚ê‚ç‚ê‚Ü‚¹‚ñ‚©„‚í‚ç‚µ
;@endmessage
;*|
;@stopse

;‘z‘œ‚µ‚Ä‚é‚Å‚ ‚ë‚¤‰¹‚Í‚ ‚è‚Ü‚¹‚Ê„‚ä‚¤‚İ
;¡“ü‚ê‚Ä‚é‚Ì‚Å—Ç‚¯‚ê‚Î
