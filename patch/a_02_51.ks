...
;---------------------------------
;※２日目ＭＡＰ/街
;2回選んだら次のシナリオへ飛ばす（02_52a）
;---------------------------------
*map
*A_02_51|空環市　弐日目の街遊び
@title name="&tf.title+  '---　空環市　弐日目の街遊び'"
@eval exp=" sf.title_list_2_2[15]=1 "
@fobgm
...
;次のシナリオに飛ぶ
@eval exp="tf.jumpTo='A_02_52a.ks'"
...
;★川沿い(D)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_d2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_51d.ks',f.黒狐p++,f.秋良p++" cond="f.scenario_flg_A_02_51d!=1" hint=""

;★商店街(E)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_e2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_51e.ks',f.秋良p++" cond="f.scenario_flg_A_02_51e!=1" hint=""
...
;★公園(P)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_p2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='A_02_51p.ks'" cond="f.scenario_flg_A_02_51p!=1" hint=""
...
@eval exp="tf.linkfrom='A_02_51.ks',tf.target='*map'"
@else
;呼び出し元
;呼び出し元
@eval exp="f.playmode='A_02_51.ks'"
