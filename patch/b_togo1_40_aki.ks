...
;▼川沿い(D)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_d1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='B_togo1_40d.ks'" cond="f.scenario_flg_B_togo1_40d!=1" hint=""

;▼商店街(E)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_e1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='B_togo1_40e.ks'" cond="f.scenario_flg_B_togo1_40e!=1" hint=""
...
;▼千年マート(I)
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_i2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='B_togo1_40i.ks'" cond="f.scenario_flg_B_togo1_40i!=1" hint=""
...
@eval exp="tf.linkfrom='B_togo1_40_aki.ks',tf.target='*map'"
@else
;呼び出し元
;呼び出し元
@eval exp="f.playmode='B_togo1_40_aki.ks'"
