...
;---------------------------------
*map
*F_kok2_20|空環市　肆日目の午前中
@title name="&tf.title+  '---　空環市　肆日目の午前中'"
...
;★MAPを表示するかどうかの判断★
;MAPのカウントが一定以上の場合
@if exp="f.map_count_f_kok2_20 == 2"

;次のシナリオに飛ぶ（MAPから次のフェーズに直接移る場合だけ）
@eval exp="tf.jumpTo='f_kok2_21.ks'"
...
;★商店街(E) ready
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_e2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20e.ks',f.灯吾p++,f.秋良p++" cond="f.scenario_flg_f_kok2_20e!=1" hint=""

;★高架下(F) ready
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_f2.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20f.ks',f.黒狐p++" cond="f.scenario_flg_f_kok2_20f!=1" hint=""

;★踏切(G) ready
@locate x=0 y=0
@button enterse="ak_se_タンバリン_01.WAV" graphic="mapicon_machi_g1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20g.ks',f.ミコトp++" cond="f.scenario_flg_f_kok2_20g!=1" hint=""


;★朔薙(H) ready
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_h1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20h.ks',f.朔薙p++,f.ミコトp++" cond="f.scenario_flg_f_kok2_20h!=1" hint=""

;★千年マート(I)

;★高校(J) ready
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_j1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20j.ks'" cond="f.scenario_flg_f_kok2_20j!=1" hint=""
...
;★駅(O) ready
@locate x=0 y=0
@button enterse="aka_se_switch04" clickse="ak_se_砂嵐_02" graphic="mapicon_machi_o1.png" recthit=false  target="*jump_to_file" exp="tf.jumpTo='f_kok2_20o.ks',f.イゴp++" cond="f.scenario_flg_f_kok2_20o!=1" hint=""
...
@eval exp="tf.linkfrom='f_kok2_20.ks',tf.target='*map'"
@else
;呼び出し元
@eval exp="f.playmode='f_kok2_20.ks'"
